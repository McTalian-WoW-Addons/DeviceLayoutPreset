...
local DLP = LibStub("AceAddon-3.0"):NewAddon(
	addonName,
	"AceConsole-3.0",
	"AceEvent-3.0",
	"AceTimer-3.0",
...
function DLP:PLAYER_ENTERING_WORLD(event, isLogin, isReload)
	...
	for i = 1, numSpecs do
		...
		if C_SpecializationInfo and C_SpecializationInfo.GetSpecializationInfo then
			specID, specName, specDesc, specIcon, specRole, specPrimaryStat =
				C_SpecializationInfo.GetSpecializationInfo(i, false, false)
		else
